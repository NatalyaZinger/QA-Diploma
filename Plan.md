...
6. Оплата по данным карты, указан невалидный месяц (1 символ в поле Месяц)  
   Номер карты 4444 4444 4444 4441, в поле Месяц указать значение 1, остальные поля заполнены валидными значениями.  
   ОР: под полем Месяц появляется сообщение об ошибке "Неверный формат", в БД в payment_entity новая запись не создается.
...
10. Оплата по данным карты, указан невалидный год (1 символ в поле Год)  
   Номер карты 4444 4444 4444 4441, в поле Год указать значение 1, остальные поля заполнены валидными значениями.  
   ОР: под полем Месяц появляется сообщение об ошибке "Неверный формат", в БД в payment_entity новая запись не создается.


11. Оплата по данным карты, указано невалидное значение в поле Владелец (кириллица)  
   Номер карты 4444 4444 4444 4441, в поле Владелец указать невалидные данные на кириллице, остальные поля заполнены валидными значениями.  
   ОР: под полем Владелец появляется сообщение об ошибке "Неверный формат", в БД в payment_entity новая запись не создается.


12. Оплата по данным карты, указано невалидное значение в поле Владелец (одно слово)  
   Номер карты 4444 4444 4444 4441, в поле Владелец указать одно слово из символов латинского алфавита, остальные поля заполнены валидными значениями.  
   ОР: под полем Владелец появляется сообщение об ошибке "Неверный формат", в БД в payment_entity новая запись не создается. 
